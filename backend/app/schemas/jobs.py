...
class JobPostingBase(BaseModel):
    ...
    location: str = Field(..., description="The geographical location of the job, or 'Remote'.")
    seniority_level: SeniorityLevel
    employment_type: EmploymentType
    description: str = Field(..., description="A detailed summary of the job and company.")
    responsibilities: List[str] = Field(..., description="A list of key responsibilities for the role.")
    qualifications: List[str] = Field(..., description="A list of formal qualifications like degrees or years of experience.")
    required_skills: List[str] = Field(..., description="A list of specific technical or soft skills.")
