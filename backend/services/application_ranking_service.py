...
from backend.schemas.job_schema import JobPosting
from backend.schemas.application_schema import Application
from backend.services.dummy_application_generator import generate_test_applications
from backend.schemas.enum_schema import (
    EmploymentType,
    SeniorityLevel,
    EducationLevel,
)
...
SENIORITY_EXPERIENCE_CURVE = {
    ...
    SeniorityLevel.MID_LEVEL: {"midpoint": 4, "steepness": 1},
    SeniorityLevel.SENIOR_LEVEL: {"midpoint": 7, "steepness": 0.8},
...
if __name__ == "__main__":
    ...
    senior_python_job = JobPosting(
        ...
        location="İstanbul",
        seniority_level=SeniorityLevel.SENIOR_LEVEL,
